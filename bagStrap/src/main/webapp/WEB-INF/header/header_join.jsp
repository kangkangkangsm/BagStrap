								...
								<div class="form_cont">
									<div class="form_col_group">
										<div class="col_box">
											<div class="valid_check">
												<div class="input_btn_box">
													<input type="text" v-model="addressDetail" class="form_ip" placeholder="번호를 입력하세요">
												</div>
											</div>
										</div>	
									</div>					
							...
							<div class="form_box">
								...
								<div class="form_cont">
									<div class="form_col_group">
										<div class="valid_check">
											<div class="input_btn_box">
												<input type="text" v-model="birth"  class="form_ip" placeholder="번호를 입력하세요">
